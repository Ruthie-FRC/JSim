...
int main() {
    ...
    // Create a simple robot assembly: base + arm with revolute joint + gripper with prismatic joint
    ...
    if (extension) {
        ...
        extension->setAnchorB(frcsim::Vector3(0.0, -0.25, 0.0)); // Local to gripper
    ...
    std::cout << "\nAfter " << world.stepCount() << " steps (" << world.accumulatedSimTimeS() << "s):\n";
    ...
    if (shoulder) {
        ...
        std::cout << "  Target velocity: " << shoulder->motorTargetVelocity() << " rad/s\n";
        std::cout << "  Has angle limits: " << (shoulder->hasLimits() ? "true" : "false") << "\n";
    }
    ...
    if (extension) {
        ...
        std::cout << "  Target velocity: " << extension->motorTargetVelocity() << " m/s\n";
        std::cout << "  Has displacement limits: " << (extension->hasLimits() ? "true" : "false") << "\n";
    }
